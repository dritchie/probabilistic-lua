#ifndef __STAN__MCMC__ADAPTIVE_HMC_DIAGGIVEN_H__
#define __STAN__MCMC__ADAPTIVE_HMC_DIAGGIVEN_H__
...
namespace stan {
  ...
  namespace mcmc {
    ...
    class adaptive_hmc_diaggiven : public ppl_hmc<BaseRNG> {
    private:
    ...
    public:
       ...
       */
      adaptive_hmc_diaggiven(stan::model::prob_grad& model,
      ...
      virtual sample next_impl() {
        ...
        for (unsigned int l = 0; l < _L; ++l)
          logp_new = ppl_hmc<>::diag_leapfrog(this->_model, this->_z, this->_inv_masses, x_new, m, g_new, epsilon,
