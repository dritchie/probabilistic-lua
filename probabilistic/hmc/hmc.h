...
void HMC_setLogprobFunction(struct HMC_SamplerState* s, LogProbFunction lpfn, GradLogProbFunction gradlpfn);
...
struct T3_SamplerState* T3_newSampler(int steps, double stepSize, GlobalTemperingProgram globTempProg, struct HMC_SamplerState* oracle);
void T3_deleteSampler(struct T3_SamplerState* s);
void T3_setLogprobFunctions(struct T3_SamplerState* s, GradLogProbFunction lpfn1, GradLogProbFunction lpfn2);
