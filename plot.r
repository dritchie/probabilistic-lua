...
PlotAcfExperiment("acf_normal", "ACF Normal, 10 sites, 1000 samples, 20 runs")
PlotAcfExperiment("acf_global", "ACF Global tempering, 10 sites, 1000 samples, 20 runs")
# PlotAcfExperiment("acf_local", "ACF Local tempering, 10 sites, 1000 samples, 20 runs")
